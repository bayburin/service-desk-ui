...
export class DashboardPageComponent implements OnInit {
  ...
  toggleQuestionLimit(service: Service): void {
    service.questionLimit = this.isNeedToDropDown(service) ? service.questionTickets.length + 1 : this.limits.questions;
  }
  ...
  isNeedToDropDown(service: Service): boolean {
    return service.questionLimit < service.questionTickets.length;
  }
